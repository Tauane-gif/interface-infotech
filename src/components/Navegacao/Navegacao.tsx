...
function Navegacao(): JSX.Element {
    ...
    const [isAuthenticated, setIsAuthenticated] = useState(() => AuthRequests.checkTokenExpiry());
    ...
    const links = [
        ...
        ...(isAuthenticated ? [
            { label: 'Produtos', icon: 'pi pi-box', url: '/lista/produtos' },
            { label: 'Movimentações', icon: 'pi pi-arrow-right-arrow-left', url: '/lista/movimentacoes' },
        ] : [])
    ];
